...
class QuestionResourceIT {
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().question(DEFAULT_QUESTION).answer(DEFAULT_ANSWER);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().question(UPDATED_QUESTION).answer(UPDATED_ANSWER);
        return question;
    }
    ...
    void putNewQuestion() throws Exception {
        ...
        updatedQuestion.question(UPDATED_QUESTION).answer(UPDATED_ANSWER);
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.question(UPDATED_QUESTION).answer(UPDATED_ANSWER);
