...
export const QuestionUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...questionEntity,
          category: questionEntity?.category?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('mcqApp.question.question')}
              ...
              />
              <ValidatedField label={translate('mcqApp.question.answer')} id="question-answer" name="answer" data-cy="answer" type="text" />
              <ValidatedField
                id="question-category"
                name="category"
                data-cy="category"
                label={translate('mcqApp.question.category')}
                type="select"
              >
                <option value="" key="0" />
                {categories
